'''
Author: bin.zhu
Date: 2022-06-24 15:59:47
LastEditors: bin.zhu
LastEditTime: 2022-06-24 16:07:02
...
class DOTABookDataset(CustomDataset):
    ...
    def __init__(self,
        ...
        super(DOTABookDataset, self).__init__(ann_file, pipeline, **kwargs)
